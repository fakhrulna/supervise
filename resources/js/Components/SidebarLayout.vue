  ...
  <div id="hs-application-sidebar" class="hs-overlay  [--auto-close:lg]
    ...
    <div class="relative flex flex-col h-full max-h-full ">
      ...
      <header class="p-4 flex justify-between items-center gap-x-2">
        <a class="flex-none font-semibold text-xl text-black focus:outline-none focus:opacity-80 dark:text-white" href="#" aria-label="Brand">SuperVise</a>
      ...
      <nav class="h-full overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
        <!-- Account Dropdown -->
        <div class="hs-dropdown [--strategy:absolute] [--auto-close:inside] relative w-full inline-flex p-2 mb-6 border-y border-gray-200 dark:border-neutral-700 justify-between">
          <button id="hs-sidebar-footer-example-with-dropdown" type="button" class="flex-1 inline-flex shrink-0 items-center gap-x-2 p-2 text-start text-sm text-gray-800 rounded-md hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:text-neutral-200 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown">
          ...
          <div class="hs-dropdown-menu hs-dropdown-open:opacity-100 w-60 transition-[opacity,margin] duration opacity-0 hidden z-20 bg-white border border-gray-200 rounded-lg shadow-lg dark:bg-neutral-900 dark:border-neutral-700" role="menu" aria-orientation="vertical" aria-labelledby="hs-sidebar-footer-example-with-dropdown">
						<div class="p-2 px-5 rounded-t-lg">
							...
							<p class="text-sm font-medium text-gray-800 dark:text-neutral-200">user1@gmail.com</p>
						</div>
            <div class="p-1">
      ...
      <!-- Footer -->
      <footer class="mt-auto p-2 border-t border-gray-200 dark:border-neutral-700 text-white">
        Logout
      </footer>
      <!-- End Footer -->
  </div>
